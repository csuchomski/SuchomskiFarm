/**
 * The farm's real geometry, as migration 044 loaded it.
 *
 * Copied from the owner's KML rather than invented, so the map and acreage
...
export const REAL_BOUNDARIES: Record<string, unknown> = {
  ...
  "Paddock 4": {"type": "Polygon", "coordinates": [[[-88.41415662, 42.87671229], [-88.413731, 42.87662757], [-88.41317476, 42.8765312], [-88.41306449, 42.87688276], [-88.41307961, 42.87719421], [-88.41269056, 42.87719684], [-88.41269599, 42.87722457], [-88.41494669, 42.87722457], [-88.41495831, 42.87686518], [-88.41415662, 42.87671229]]]},
  "Paddock 5": {"type": "Polygon", "coordinates": [[[-88.41335974, 42.87722457], [-88.41269599, 42.87722457], [-88.41291314, 42.87833348], [-88.41335974, 42.87833348], [-88.41335974, 42.87722457]]]},
};
...
export const REAL_SWEEP: Record<string, { headingDeg: number; lengthFt: number }> = {
  ...
  "Paddock 4": { headingDeg: 90, lengthFt: 607 },
